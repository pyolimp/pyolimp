...
class ResidualDenseBlock_5C(nn.Module):
    def __init__(
        ...
        self.conv2 = conv(
            nc + gc, gc, kernel_size, stride, padding, bias, mode
        )
        self.conv3 = conv(
            nc + 2 * gc, gc, kernel_size, stride, padding, bias, mode
        )
        self.conv4 = conv(
            nc + 3 * gc, gc, kernel_size, stride, padding, bias, mode
        )
        self.conv5 = conv(
...
class NonLocalBlock2D(nn.Module):
    def __init__(
        ...
        self.theta = conv(
            nc, inter_nc, kernel_size, stride, padding, bias, mode="C"
        )
